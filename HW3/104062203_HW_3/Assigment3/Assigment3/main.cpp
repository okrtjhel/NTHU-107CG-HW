...
void onMouse(int who, int state, int x, int y)
{
	...
	case GLUT_LEFT_BUTTON:
		...
		{
			lightInfo[2].spotExponent -=10;
		}
		lightInfo[2].spotExponent = (lightInfo[2].spotExponent < 0) ? 0 : lightInfo[2].spotExponent;
		current_x = x;
		current_y = y;
		break;
...
void onKeyboard(unsigned char key, int x, int y)
{
	...
	case 'h':
		...
		cout << endl << endl;
		cout << "current transformation mode: ";
		...
		if (light_idx == 0 || light_idxv == 0) {
			cout << endl;
			cout << "--------directional light info--------" << endl;
		...
		if (light_idx == 1 || light_idxv == 1) {
			cout << endl;
			cout << "-----------point light info-----------" << endl;
		...
		if (light_idx == 2 || light_idxv == 2) {
			cout << endl;
			cout << "-----------spot light info------------" << endl;
			cout << "position: " << lightInfo[2].position << endl;
			cout << "ambient: " << lightInfo[2].ambient << endl;
			cout << "diffuse: " << lightInfo[2].diffuse << endl;
			cout << "specular: " << lightInfo[2].specular << endl;
			cout << "spotDirection: " << lightInfo[2].spotDirection << endl;
			cout << "spotExponent: " << lightInfo[2].spotExponent << endl;
...
void initParameter()
{
	...
	lightInfo[2].position = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
