	...
	while (group)
	{
		...
		if (strlen(m.obj->materials[group->material].textureImageName) != 0)
		{
			...
			glTexImage2D(GL_TEXTURE_2D, // target
						...
						m.group[curGroupIdx].infoHeader.Width, // width
						m.group[curGroupIdx].infoHeader.Height, // height
						0, // border
						GL_BGR, // format
						GL_UNSIGNED_BYTE, // type
						m.group[curGroupIdx].image // *pixels
			);
...
void onKeyboard(unsigned char key, int x, int y)
{
	...
	case 'h':
		...
		{
		case VertexLighting:
			cout << "current main mode: VertexLighting" << endl;
			break;
		case PixelLighting:
			cout << "current main mode: PixelLighting" << endl;
			break;
		case Geometric:
			cout << "current main mode: Geometric" << endl;
			break;
		case Viewing:
			cout << "current main mode: Viewing" << endl;
			break;
		case Texture:
			cout << "current main mode: Texture" << endl;
			break;
		}
		switch (cur_sub_mode)
		{
		case LightDirectional:
			cout << "current sub mode: LightDirectional" << endl;
			break;
		case LightPoint:
			cout << "current sub mode: LightPoint" << endl;
			break;
		case GeoTranslation:
			cout << "current sub mode: GeoTranslation" << endl;
			break;
		case GeoRotation:
			cout << "current sub mode: GeoRotation" << endl;
			break;
		case GeoScaling:
			cout << "current sub mode: GeoScaling" << endl;
			break;
		case ViewCenter:
			cout << "current sub mode: ViewCenter" << endl;
			break;
		case ViewEye:
			cout << "current sub mode: ViewEye" << endl;
			break;
		}
		cout << "model index: " << cur_idx << endl;

		cout << endl;
		cout << "----------------model info---------------" << endl;
		cout << "position: " << models[cur_idx].position <<  endl;
		cout << "scale:    " << models[cur_idx].scale << endl;
		cout << "rotation: " << models[cur_idx].rotation << endl;
		cout << "-----------------------------------------" << endl;

		cout << endl;
		cout << "---------------camera info---------------" << endl;
		cout << "position:  " << camera.position << endl;
		cout << "center:    " << camera.center << endl;
		cout << "up vector: " << camera.upVector << endl;
		cout << "-----------------------------------------" << endl;

		cout << endl;
		cout << "--------------lighting info--------------" << endl;
		if (lightTypePixel == 0 || lightTypeVertex == 0) {
			cout << endl;
			cout << "directional light:" << endl;
			cout << "position: " << lightInfo[0].position << endl;
			cout << "ambient:  " << lightInfo[0].ambient << endl;
			cout << "diffuse:  " << lightInfo[0].diffuse << endl;
			cout << "specular: " << lightInfo[0].specular << endl;
		}
		if (lightTypePixel == 1 || lightTypeVertex == 1) {
			cout << endl;
			cout << "point light:" << endl;
			cout << "position: " << lightInfo[1].position << endl;
			cout << "ambient:  " << lightInfo[1].ambient << endl;
			cout << "diffuse:  " << lightInfo[1].diffuse << endl;
			cout << "specular: " << lightInfo[1].specular << endl;
			cout << "constantAttenuation:  " << lightInfo[1].constantAttenuation << endl;
			cout << "linearAttenuation:    " << lightInfo[1].linearAttenuation << endl;
			cout << "quadraticAttenuation: " << lightInfo[1].quadraticAttenuation << endl;
		}
		cout << "-----------------------------------------" << endl;

		cout << endl;
		cout << "------------texture parameter------------" << endl;
		cout << "mag_linear: " << mag_linear << endl;
		cout << "min_linear: " << min_linear << endl;
		cout << "warp_clamp: " << warp_clamp << endl;
		cout << "-----------------------------------------" << endl;
